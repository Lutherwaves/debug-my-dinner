...
export const PostLayout: Model = {
    ...
    label: 'Post',
    labelField: 'title',
    filePath: 'content/pages/cooks/{slug}.md',
    fieldGroups: [
        {
            name: 'thumbnail',
            label: 'Thumbnail',
    ...
    fields: [
        {
            ...
            label: 'Title',
            required: true,
            default: 'This is a cooks post title',
            hidden: false,
            localized: false
        },
        ...
        },
        {
            type: 'boolean',
            name: 'isFeatured',
            label: 'Exclude from cooks feed',
            description:
                "Enable this option to avoid a featured post (in a 'Featured posts' section) to appear duplicated in the cooks page.",
            required: false,
            default: false,
            hidden: false,
            localized: false,
